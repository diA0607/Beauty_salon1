<%@ Page Language="C#" MasterPageFile="~/Site1.Master" AutoEventWireup="true" CodeBehind="Lk_zakaz.aspx.cs"  Inherits="ASOIU4.Lk_zakaz" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <asp:DropDownList ID="DropDownList2" runat="server" AutoPostBack="True" AppendDataBoundItems="true" DataSourceID="SqlDataSource1" DataTextField="ФИО" DataValueField="ID_сотрудника" OnSelectedIndexChanged="DropDownList2_SelectedIndexChanged1">

        <asp:ListItem Selected="True" Value="0">Не выбрано</asp:ListItem>
    </asp:DropDownList>
    <asp:SqlDataSource runat="server" ID="SqlDataSource1" ConnectionString='<%$ ConnectionStrings:beautyConnectionString %>' SelectCommand="SELECT [ID_сотрудника], [ФИО] FROM [Сотрудники]" OnSelecting="SqlDataSource1_Selecting"></asp:SqlDataSource>
   <br>
    <asp:Button ID="Button4" runat="server" Text="Оформить" OnClick="Button4_Click" />
</asp:Content>